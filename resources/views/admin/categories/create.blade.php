        ...
        <form action="{{ route('admin.categories.store') }}" method="POST">
            ...
            <div class="mb-6">
                <label class="flex items-center">
                    <input type="checkbox" name="allow_image_uploads" value="1" class="form-checkbox h-5 w-5 text-blue-600 bg-gray-700 border-gray-600 rounded focus:ring-blue-500">
                    <span class="ml-2 text-sm text-gray-300">Allow image uploads for nominations in this category</span>
                </label>
            </div>
